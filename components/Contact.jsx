                ...
                <div className="info__container">
                  <div className="info phone">
                    ...
                    <div className="phone__number">
                      <p className="number__1">04-2683101 | 050-5154215</p>

                      <p className="number__2">058-8771414 | 058-8259312</p>
                    </div>
                  </div>
                  ...
                  <div className="info email">
                    ...
                    <div className="email__mail">
                      <p>thawakkaltransport@gmail.com</p>
                    </div>
                  </div>
                  ...
                  <div className="info address">
                    ...
                    <div className="address__address">
                      <p>
                        Office # 10, Sajaya 20 Building, Near Excellence Driving School, Al Qusais Industrial Area # 5, Al Qusais, Dubai, UAE.
